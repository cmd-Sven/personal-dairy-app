...
function EditEntryModal({ entry, isOpen, onClose, onEntryUpdated }) {
  ...
  const validateForm = () => {
    ...
    if (!formData.imageUrl.trim()) {
      setError("FEHLER: Bild-Link wird benötigt!");
      return false;
    }
  ...
  const handleSubmit = (e) => {
    ...
    if (updatedEntry) {
      ...
      setError("SYSTEMFEHLER: Log-Eintrag konnte nicht aktualisiert werden. Bitte erneut versuchen.");
    }
  };
      ...
      <div className="bg-gradient-to-br from-[#1a1a3e] to-[#0a0e27] rounded-none shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto border-4 border-[#9999ff] animate-slideUp">
          ...
          <div className="flex items-center justify-between relative z-10">
            <div>
              ...
              <p className="text-sm font-bold tracking-widest uppercase opacity-80">
                DATENBANK-UPDATE • BEARBEITUNGSMODUS AKTIV
              </p>
            </div>
            <button
              onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          ...
          <div className="flex gap-4 pt-6">
            ...
            >
              <span className="relative z-10">LOG AKTUALISIEREN</span>
