...
function MoodSelector({ selectedMood, onMoodChange }) {
  const moods = [
    ...
    },
    {
      ...
      icon: "🔴",
      label: "Red Alert",
      description: "Schilde auf Maximum!",
    ...
    },
    {
      ...
      icon: "☕",
      label: "Replicator Pause",
      description: "Tee, Earl Grey, Heiss",
    ...
    },
    {
      id: "away-mission",
      icon: "🚀",
      label: "Mission angenommen!",
      description: "Beam Me Up!... eagl was uns erwartet.",
    ...
    },
    {
      id: "battle",
      icon: "🚀",
      label: "Phaser auf Betäubung",
      description: "Wir kommen in Frieden!",
      color: "from-[#66ccff] to-[#99ffcc]",
      borderColor: "border-[#66ccff]",
    },
  ];
      ...
      {selectedMood && (
        <div className="mt-4 p-4 bg-gradient-to-r from-[#1a1a3e]/80 to-[#0a0e27]/80 backdrop-blur-sm border-l-4 border-[#ff9c00] rounded-none">
          <p className="text-[#9999ff] text-sm font-bold uppercase tracking-wide">
            STATUS:{" "}
            {moods.find((m) => m.id === selectedMood)?.label.toUpperCase()}
          </p>
        </div>
      )}
    </div>
